...
def handle_environment_variables(server_args: Any):
    ...
    if not get_platform().is_cuda:
        ...
        # disabled on NPU/XPU/CPU even though the environment option defaults
        # to true; deepseek_v4.py reads the flag directly during weight load,
        # so leaving it on relies on the launcher exporting =0.
