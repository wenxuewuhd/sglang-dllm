...
register_cuda_ci(est_time=10, stage="base-c", runner_config="4-gpu-h100")
register_cuda_ci(est_time=9, stage="base-c", runner_config="4-gpu-b200")
register_cuda_ci(est_time=12, stage="base-c", runner_config="4-gpu-gb300")
