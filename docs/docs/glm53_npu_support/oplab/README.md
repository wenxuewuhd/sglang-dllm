...
|---|---|---|---|---|---|
| **KDA** | 34 | **289.4 µs** | **9.841 ms** | 10.357 ms | **−5.0%** |
| KDA（真跑 34 个不同层） | 34 | — | **9.623 ms** | 10.357 ms | −7.1% |
| **DSA**（n=256） | 11 | **445.3 µs** | **4.898 ms** | 5.143 ms | **−4.8%** |
| DSA（真跑 11 个不同层，各自的池子） | 11 | — | **5.320 ms** | 5.143 ms | **+3.4%** |
