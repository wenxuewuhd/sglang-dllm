...
| **长上下文** | ✅ **2026-08-30 跑通 1,048,576**（INT8 W8A8 TP8，**8 张 die，不用整机**）。五深度召回 5/5；32768 长的前缀对拍 `max\|dlp\| = 0.000e+00`；TTFT 347.6 s、decode 32.9 ms/token。见 **P7** |
...
- [ ] **BF16 TP16 的交付构型确认** —— 要整机。容量已算过：mem-frac 0.85 / mrr 16 下
      1,195,072 token > 1,048,576，**富余 146k，装得下**，所以这是确认不是探索。
